...
<div class="content">
   <div class="container-fluid">
       <div class="row">
           <div class="col-md-12">
            <a href="/admin/pr" class="btn btn-fill btn-danger shadow mb-2"><i class="material-icons" style="font-size: 15px">arrow_back</i>Kembali</a>
               <div class="card">
                   <div class="card-body">
                       <form method="POST" action="">
                        @csrf
                           ...
                           <button type="submit" class="btn shadow btn-danger btn-fill btn-block">Update PR</button>
                       </form>
                     </div>
